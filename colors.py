...
colors= """gray60 gray70 gray80 gray85 gray90 gray95 \
...
class ColorsDemo(DemoWindow):
    ...
    def callback(self, event):
        color = self.list.list.selection_get()
        self.tk_setPalette(color)
        

# this is equivalent than defining a runDemo function
runDemo = ColorsDemo
