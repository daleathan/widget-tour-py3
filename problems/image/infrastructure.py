...
def rundemo(demo_code):
    ...
    if _CurrentDemo :
        exec _CurrentDemo.destroy()

    exec demo_code # this reassigns _CurrentDemoClass
    
    # reassign _CurrentDemo and start the new demo
    exec ('_CurrentDemo = %s()' % _CurrentDemoName )
